...
// The native macOS helper owns utun allocation and validates system routes.
// Xray expands /0 into Darwin protected routes, preserving the physical
// interface's default route for sockets bound with IP_BOUND_IF.
const FULL_TUN_ROUTES = ["0.0.0.0/0", "::/0"];
