...
execFileSync('xcrun', ['swiftc', '-swift-version', '5', '-O', '-target', `${arch === 'x64' ? 'x86_64' : arch}-apple-macos13.0`, '-module-cache-path', `${output}/module-cache`, 'native/Helper.swift', '-o', `${output}/levik-helper`, '-framework', 'SystemConfiguration', '-framework', 'Security'], { stdio: 'inherit' });
